...
public partial class ClasseRegistry : Node
{
    ...
    private static List<ClasseCustomResource> CriarClassesFallback()
    {
        var mago = new ClasseCustomResource
        {
            ...
            UsaProjetil = true,
            CenaDoProjetil = ResourceLoader.Load<PackedScene>("res://resources/Projetil/ProjetilMage.tscn"),
        ...
        var arqueiro = new ClasseCustomResource
        {
            ...
            UsaProjetil = true,
            CenaDoProjetil = ResourceLoader.Load<PackedScene>("res://resources/Projetil/ProjetilArqueiro.tscn"),
        ...
        var prist = new ClasseCustomResource
        {
            ...
            UsaProjetil = true,
            CenaDoProjetil = ResourceLoader.Load<PackedScene>("res://resources/Projetil/Projetil.tscn"),
